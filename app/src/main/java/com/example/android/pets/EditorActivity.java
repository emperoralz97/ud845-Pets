...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * True only if user update part of the pet form
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // in order to figure our if we're creating a new pet or editing an existing one.
    ...
    private void savePet() {
        ...
        if (currentUri == null && TextUtils.isEmpty(nameString) || TextUtils.isEmpty(breedString) || mGender == PetEntry.GENDER_UNKNOWN) {
        ...
        if (currentUri == null) {
            ...
            // Update the old into the provider
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                // If the pet hasn't changed, continue with navigationg up to parent activity
                ...
                DialogInterface.OnClickListener discardButtonClickLister = new DialogInterface.OnClickListener() {
                    @Override
                ...
                showUnsavedChangesDialog(discardButtonClickLister);
                return true;
        }
    ...
    // Otherwise if there are unsaved changes, setup a dialog to warn the user.
    // Create a click listener to handle the user confirming the change should be discarded.
